...
var App = function App(_ref) {
  ...
  var children = piral.getChildModules(piral);
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_0__.useState(children.length && children[0].link),
    _React$useState2 = _slicedToArray(_React$useState, 2),
    activePlugin = _React$useState2[0],
    setActivePlugin = _React$useState2[1];
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  ...
  }, activePlugin ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    style: {
      marginLeft: 60
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(piral.Extension, {
    name: "".concat(activePlugin)
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      ...
      onClick: function onClick() {
        return setActivePlugin(child.link);
      }
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(piral.Extension, {
      name: "".concat(child.link, "/icon")
    }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_3__["default"], null));
  }))) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "No children were passed to this module. Please check the configuration."));
};
...
var Transition = /*#__PURE__*/function (_React$Component) {
    ...
    if (nextStatus !== null) {
      ...
      if (nextStatus === ENTERING) {
        if (this.props.unmountOnExit || this.props.mountOnEnter) {
          var node = this.props.nodeRef ? this.props.nodeRef.current : react_dom__WEBPACK_IMPORTED_MODULE_3__["default"].findDOMNode(this); // https://github.com/reactjs/react-transition-group/pull/749
  ...
  _proto.performEnter = function performEnter(mounting) {
    ...
    var _ref2 = this.props.nodeRef ? [appearing] : [react_dom__WEBPACK_IMPORTED_MODULE_3__["default"].findDOMNode(this), appearing],
        maybeNode = _ref2[0],
  ...
  _proto.performExit = function performExit() {
    ...
    var timeouts = this.getTimeouts();
    var maybeNode = this.props.nodeRef ? undefined : react_dom__WEBPACK_IMPORTED_MODULE_3__["default"].findDOMNode(this); // no exit animation skip right to EXITED
  ...
  _proto.onTransitionEnd = function onTransitionEnd(timeout, handler) {
    ...
    var node = this.props.nodeRef ? this.props.nodeRef.current : react_dom__WEBPACK_IMPORTED_MODULE_3__["default"].findDOMNode(this);
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      react__WEBPACK_IMPORTED_MODULE_2__["default"].createElement(_TransitionGroupContext__WEBPACK_IMPORTED_MODULE_6__["default"].Provider, {
        value: null
...
function setup(app) {
  ...
  var Module = connect(function (_ref) {
    ...
    return app.withState(_App__WEBPACK_IMPORTED_MODULE_0__["default"], {
      app: app,
      state: state,
      actions: actions
    });
  });
  app.showNotification("Loaded ".concat(app.meta.name, " component!"), {
    autoClose: 2000
  });
